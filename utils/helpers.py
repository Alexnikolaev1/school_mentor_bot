...
MENU_BUTTONS = frozenset({
    "📚 Объяснить тему", "📝 Проверить ДЗ", "📖 Энциклопедические знания",
    "📊 Диагностика", "🎓 Экзамен",
    ...
    "⏹ Стоп", "🏠 Меню",
    # Энциклопедия
    "📌 Краткий справочник", "📚 Полная статья", "🕐 Хронология", "🔗 Карта связей",
    "📚 Углубить", "🔗 Связанные темы", "🎯 Проверить знания", "🔊 Озвучить", "📖 Новая тема",
})
